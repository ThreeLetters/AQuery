...
d[c];if(e){d.splice(c,1);var f=a.listeners.indexOf(e);-1!==e&&a.listeners.splice(f,1);a.current.removeEventListener(e.type,e.listener)}}}})},deleteProperty:function(b,c){if("number"===typeof c){var d=a.listeners[c];d&&(a.listeners.splice(c,1),a.current.removeEventListener(d.type,d.listener))}else a.listeners=a.listeners.filter(function(b){return b.type===c?(a.current.removeEventListener(b.type,b.listener),!1):!0})}})};t.on=t.addEventListener=function(a,b,c){if("delete"===c)a.listeners.forEach(function(b){a.wrappers.forEach(function(a){var c=
a.listeners.indexOf(b);-1!==c&&(a.listeners.splice(c,1),a.current.removeEventListener(b.type,b.listener))})}),a.listeners=[];else return new Proxy(function(c,g,f){var d=g._listenerData=g._listenerData||{selector:a.selector,type:c,listener:g,options:f};-1===a.listeners.indexOf(d)&&a.listeners.push(d);a.nodes.forEach(function(b,m){-1===a.wrappers[m].listeners.indexOf(d)&&(b.addEventListener(c,g,f),a.wrappers[m].listeners.push(d))});b&&-1===z.indexOf(d)&&z.push(d)},{get:function(b,c){if("length"===c)return a.listeners.length;
if("number"===typeof c)return a.listeners[c].listener;var d=[];a.listeners.forEach(function(a){a.type===c&&d.push(a.listener)});return new Proxy(d,{deleteProperty:function(b,c){if("number"===typeof c){var e=d[c];if(e){d.splice(c,1);var f=a.listeners.indexOf(e);-1!==e&&a.listeners.splice(f,1);a.wrappers.forEach(function(a){a=a.elementData;var b=a.listeners.indexOf(e);-1!==b&&(a.current.removeEventListener(e.type,e.listener),a.listeners.splice(b,1))})}}}})},deleteProperty:function(b,c){if("number"===
typeof c){var d=a.listeners[c];d&&(a.listeners.splice(c,1),a.wrappers.forEach(function(a){a=a.elementData;var b=a.listeners.indexOf(d);-1!==b&&(a.current.removeEventListener(d.type,d.listener),a.listeners.splice(b,1))}))}else elementData.listeners=elementData.listeners.filter(function(b){return b.type===c?(elementData.current.removeEventListener(b.type,b.listener),a.wrappers.forEach(function(a){a=a.elementData;var c=a.listeners.indexOf(b);-1!==c&&(a.current.removeEventListener(b.type,b.listener),
a.listeners.splice(c,1))}),!1):!0})}})};var T=new Proxy(function(a){if(a){if("string"===typeof a){var b=Array.from(u.querySelectorAll(a));return Q(b,a)}if("object"===typeof a)return w(a)}},{get:function(a,b){if(y[b])return y[b](b);if(H[b])return H[b]},set:function(a,b,c){}});l.AQuery=T;l.$||(l.$=l.AQuery)})(window);
